...
import model.dao.interfaces.IHotelDAO;
...
public class HotelDAO implements IHotelDAO {
    ...
    public void insert(Hotel hotel) {
        ...
        String sql = "INSERT INTO cidades(id_cidade,nome,qtd_estrelas,valor_min,wifi,cafe_manha,cep,logradouro,bairro)" +
                " VALUES(?,?,?,?,?,?,?,?,?)";
    ...
    public void updateById(Hotel hotel){
        ...
        try {
            ...
            pstm.setDouble(4,hotel.getValor_min());
            pstm.setBoolean(5,hotel.isWifi());
            pstm.setString(6,hotel.getCep());
            pstm.setString(7,hotel.getLogradouro());
            pstm.setString(8,hotel.getBairro());
