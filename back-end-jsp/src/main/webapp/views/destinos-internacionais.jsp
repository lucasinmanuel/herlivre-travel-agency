...
<head>
  ...
  <title>Herlivre - Viagens Internacionais</title>
  ...
  <main>
    <section class="destino">
      ...
      <div class="container py-5">
          ...
          <div class="col-12 col-xl-6 d-flex justify-content-center justify-content-xl-end pe-3">
            <div class="w-50 border border-info d-flex rounded-pill text-center">
              <div style="width: 45%" class="border-end border-info py-2">
                <a href="destinos-nacionais.jsp" class="text-decoration-none text-info">Nacional</a>
              </div>
              <div style="width: 55%" class="align-self-center">
                <a href="destinos-internacionais.jsp" class="text-decoration-none text-info fw-bold">Internacional</a>
              </div>
            </div>
          </div>
          <!--col-->
        ...
        <div class="row p-0">
          <div class="continentes-wrapper col-12 d-flex flex-wrap px-4 px-xl-0 my-4 text-center">
            <div style="width: 32.3%; margin-right: 1%; min-height: 320px" class="position-relative mb-2">
              <a href="#">
                ...
                <img width="100%" height="100%" class="rounded-3"
                  src="../images/bg-continentes/américa-do-norte-new-york.jpg" alt="foto da cidade de New York" />
              </a>
            </div>
            <!--continente-->
            ...
            <div style="width: 32.3%; margin-right: 1%; min-height: 320px" class="position-relative mb-2">
              <a href="#">
                ...
                <div style="opacity: 0.5" class="w-100 h-100 position-absolute bg-dark rounded-3"></div>
                <img width="100%" height="100%" class="rounded-3" src="../images/bg-continentes/europa-paris.jpg"
                  alt="foto da cidade de Paris" />
              </a>
            </div>
            <!--continente-->
            ...
            <div style="width: 32.3%; margin-right: 1%; min-height: 320px" class="position-relative mb-2">
              <a href="#">
                ...
                <div style="opacity: 0.5" class="w-100 h-100 position-absolute bg-dark rounded-3"></div>
                <img width="100%" height="100%" class="rounded-3" src="../images/bg-continentes/áfrica-marrocos.jpg"
                  alt="foto da cidade de Marrocos" />
              </a>
            </div>
            <!--continente-->
            ...
            <div style="width: 32.3%; margin-right: 1%; min-height: 320px" class="position-relative mb-2">
              <a href="#">
                ...
                <div style="opacity: 0.5" class="w-100 h-100 position-absolute bg-dark rounded-3"></div>
                <img width="100%" height="100%" class="rounded-3"
                  src="../images/bg-continentes/américa-central-costa-rica.jpg" alt="foto da cidade de Costa Rica" />
              </a>
            </div>
            <!--continente-->
            ...
            <div style="width: 32.3%; margin-right: 1%; min-height: 320px" class="position-relative mb-2">
              <a href="#">
                ...
                <div style="opacity: 0.5" class="w-100 h-100 position-absolute bg-dark rounded-3"></div>
                <img width="100%" height="100%" class="rounded-3" src="../images/bg-continentes/américa-do-sul-lima.jpg"
            ...
            <div style="width: 32.3%; margin-right: 1%; min-height: 320px" class="position-relative mb-2">
              <a href="#">
                ...
                <div style="opacity: 0.5" class="w-100 h-100 position-absolute bg-dark rounded-3"></div>
                <img width="100%" height="100%" class="rounded-3" src="../images/bg-continentes/ásia-bangkok.jpg"
                  alt="foto da cidade de Bangkok" />
              </a>
            </div>
            <!--continente-->
          </div>
