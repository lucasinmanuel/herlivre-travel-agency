...
<head>
  ...
  <title>Herlivre - Faça o Login</title>
      ...
      <div class="row">
        <div class="col-11 col-md-8 col-xl-5 mx-auto p-3 rounded-3 shadow-lg bg-light">
          ...
          <form method="post" action="./login">
            ...
            <input required id="senha" class="w-100 form-control" type="password" name="password" />
          ...
          <div>
            ...
            <a class="me-2" href="https://gmail.com">
              <img width="32px" alt="Gmail Logo" src="../images/icons/gmail.svg" alt="Ícone Gmail" />
            </a>
            <a href="https://facebook.com">
              <img width="32px" alt="Facebook Logo" src="../images/icons/facebook.png" alt="Ícone Facebook" />
            </a>
    ...
    <div class="container py-4">
      <div class="row mt-3">
        <div class="col-12 text-center">
          <a class="navbar-brand" href="./index.jsp"><img src="../images/logos/herlivre.png" width="200px" /></a>
        </div>
        <!--col-->
      </div>
      <!--row-->
      ...
      <div class="row">
        <div class="col-12 text-center mt-4">
          ...
          <a href="https://www.facebook.com/" class="d-inline-block mx-2 mb-2" target="_blank">
            <img width="50px" src="../images/icons/facebook.png" alt="ícone facebook" /></a>
          <a href="https://www.instagram.com/" class="d-inline-block mx-2 mb-2" target="_blank">
            <img width="50px" src="../images/icons/instagram.png" alt="ícone instagram" /></a>
          <a href="https://twitter.com/" class="d-inline-block mx-2 mb-2" target="_blank">
            <img width="50px" src="../images/icons/twitter.png" alt="ícone twitter" /></a>
          <a href="https://www.tiktok.com/" class="d-inline-block mx-2 mb-2" target="_blank">
            <img width="50px" src="../images/icons/tik-tok.png" alt="ícone tik tok" /></a>
        </div>
        <!--col-->
      </div>
      <!--row-->
