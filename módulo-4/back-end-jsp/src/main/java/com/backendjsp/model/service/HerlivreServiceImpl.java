...
import com.backendjsp.model.dao.*;
import com.backendjsp.model.entity.*;
...
public class HerlivreServiceImpl implements IHerlivreService {
    ...
    public int getQuartosByNomeHotel(String nome_hotel) {
        ...
        int id_hotel = cidadeDAO.getIdByNome(nome_hotel);
        ...
        System.out.println("______________ LISTA DE PACOTES ________________");
            ...
            for (Voo v : vooDAO.getVoos()) {
                ...
                for (Pacote p : pacoteDAO.getPacotesByIdVoo(v.getId())) {
                    RegistroAluguelQuarto registro = registroAluguelQuartoDAO.getById(p.getId_registroaluguelquarto());
    ...
    public List<Date> converteFormatoData(String entrada, String saida) {
    ...
    public Date converteFormatoData(String generic_data) {
