...
import com.backendjsp.model.dao.interfaces.ICidadeDAO;
...
public class CidadeDAO implements ICidadeDAO {
    ...
    public void insert(Cidade cidade) {
        ...
        String sql = "INSERT INTO cidades(nome,uf,pais,continente)" + " VALUES(?,?,?,?)";
    ...
    public void updateById(Cidade cidade){
        ...
        String sql = "UPDATE cidades SET nome = ?,uf = ?,pais = ?,continente = ? WHERE id = ?";
